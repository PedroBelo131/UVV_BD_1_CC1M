...
#### "select 
#### concat(f.primeiro_nome, " ", f.nome_meio, " ", f.ultimo_nome) as nome_completo_funcionario, 
...
#### concat(f.idade, " anos") as idade_funcionario, 
#### concat(year(curdate())-year(d.data_nascimento)," anos") as idade_dependente 
